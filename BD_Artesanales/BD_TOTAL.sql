...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "PROYECTO_DB"."SEQ_DETALLE_VENTA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into PROYECTO_DB.PRODUCTOS (ID_PRODUCTO,NOMBRE,DESCRIPCION,PRECIO,STOCK,ID_PROVEEDOR,ID_CATEGORIA) values (1,'Taza de Cerámicaaaaaa','Taza hecha a mano con diseño único',15,48,1,1);
Insert into PROYECTO_DB.PRODUCTOS (ID_PRODUCTO,NOMBRE,DESCRIPCION,PRECIO,STOCK,ID_PROVEEDOR,ID_CATEGORIA) values (3,'Bufanda de Lana','Bufanda tejida a manoas',20,19,1,3);
Insert into PROYECTO_DB.PRODUCTOS (ID_PRODUCTO,NOMBRE,DESCRIPCION,PRECIO,STOCK,ID_PROVEEDOR,ID_CATEGORIA) values (11,'ad','asd',23,1,7,11);
...
Insert into PROYECTO_DB.VENTAS (ID_VENTA,ID_CLIENTE,FECHA_VENTA,TOTAL,ID_EMPLEADO,ESTADO) values (10,6,to_date('18-AUG-25','DD-MON-RR'),0,1,'ACTIVA');
--------------------------------------------------------
